...
exports.install = function (packages, save) {
    ...
    if (depedencies.length) {
        ...
        chain.next(installer.bowerInstaller(pkgConfig, bowerConfig, save));
        chain.next(installer.requirejsInstaller(bowerConfig));
...
exports.build = function (input, output) {
    ...
    var builder = installer.requirejsOptimization(bowerConfig, input, output);
